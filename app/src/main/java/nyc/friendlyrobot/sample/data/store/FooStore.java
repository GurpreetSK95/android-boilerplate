...
import nyc.friendlyrobot.sample.data.model.Bar;
import nyc.friendlyrobot.sample.data.model.Foo;
import nyc.friendlyrobot.sample.data.model.FooModel;
import nyc.friendlyrobot.sample.data.model.ImmutableFoo;
import nyc.friendlyrobot.sample.data.model.ImmutableLoo;
import nyc.friendlyrobot.sample.data.model.Loo;
import nyc.friendlyrobot.sample.data.remote.Api;
import nyc.friendlyrobot.sample.interaction.FooAction;
import rx.Observable;

import static nyc.friendlyrobot.sample.data.model.Foo.MAPPER;
